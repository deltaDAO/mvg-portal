              ...
              <div className="text-center">
                <svg
                  className={`h-12 w-12 mx-auto mb-3 ${
                    zipFile ? 'text-blue-500' : 'text-gray-400'
                  }`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                ...
                <span
                  className={`block text-sm font-medium ${
                    zipFile ? 'text-blue-600' : 'text-gray-700'
                  }`}
                >
          ...
          <div className="relative">
            ...
            >
              <div className="text-center">
                ...
                <span
                  className={`block text-sm font-medium ${
                    files.length > 0 ? 'text-blue-600' : 'text-gray-700'
                  }`}
                >
                  {files.length > 0
                ...
                <ul className="text-xs text-gray-600 space-y-1.5">
                  {files.map((file, index) => {
                    ...
                    return (
                      <li
                        key={index}
                        className="flex items-center p-1 border-b border-gray-100 last:border-b-0"
                      >
                        <svg
                          className="h-3 w-3 mr-1.5 text-blue-500 flex-shrink-0"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
