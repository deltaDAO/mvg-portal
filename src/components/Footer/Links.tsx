...
export default function Links(): ReactElement {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-y-8 md:gap-x-12 w-full">
        {/* Partner Logos - Left Side (2 columns of the grid) */}
        <div className="md:col-span-2">
          <div className="w-sm flex flex-wrap gap-4 mt-8">
        ...
        <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-4 md:pl-8 md:border-gray-200">
          {/* Column 1: Clio-X */}
          <div>
            {/* Logo as title */}
          ...
          <div className="md:col-span-2">
            ...
            <p className={`${styles.subtitle} text-sm max-w-xs mb-4`}>
              Our newsletter provides you with latest data economy happenings on
              a monthly basis.
            </p>
