...
export default function Button({
  ...
  const variantClasses = {
    primary:
      'bg-[#c8794d] text-white border-2 border-[#c8794d] hover:bg-[#d9955a] hover:border-[#d9955a] hover:scale-[1.01]',
    secondary:
      'bg-[#f2e5d5] text-black border-2 border-[#f2e5d5] hover:bg-[#f2e5d5] hover:scale-[1.01]',
    outline:
      'border border-[#282939] text-[#282939] hover:text-[#c8794d] hover:border-[#c8794d] hover:scale-[1.01]'
  }
