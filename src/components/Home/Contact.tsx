                  ...
                  {contact.socialSection.contacts.map(
                    (socialContact, index) => (
                      <div key={index} className="flex items-center gap-3">
                        ...
                        {socialContact.platform === 'LinkedIn' && (
                          <svg
                            className="w-6 h-6"
                            style={{ color: '#734B3D' }}
                            fill="currentColor"
                            viewBox="0 0 24 24"
                          >
                            <path d="M19.3 3H4.7C3.776 3 3 3.776 3 4.7v14.6c0 .924.776 1.7 1.7 1.7h14.6c.924 0 1.7-.776 1.7-1.7V4.7c0-.924-.776-1.7-1.7-1.7zM8.339 18.338H5.667v-8.59h2.672v8.59zM7.004 8.574a1.548 1.548 0 11-.002-3.096 1.548 1.548 0 01.002 3.096zm11.335 9.764H15.67v-4.177c0-.996-.017-2.278-1.387-2.278-1.389 0-1.601 1.086-1.601 2.206v4.249h-2.667v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.779 3.203 4.092v4.711z" />
                          </svg>
                        )}
                        <a
