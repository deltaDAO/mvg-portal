...
export default function ComputeWizard({
  ...
  console.log('allResourceValues ', allResourceValues)
  ...
  const onSubmit = async (values: FormComputeData) => {
    ...
    try {
      ...
      console.log('calling on submit!!!!!!!!! 2')
      ...
      console.log('calling on submit!!!!!!!!! 3')
